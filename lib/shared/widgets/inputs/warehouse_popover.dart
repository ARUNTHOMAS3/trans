                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: _WarehousePopoverContent(
                        ...
                        selectedStockType:
                            widget.selectedStockType ?? 'Physical',
                        onViewChanged: (v) {
          ...
          child: Column(
            ...
            children: [
                            ...
                            children: [
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color:
                                        _localSelectedStockType == 'Accounting'
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: _localSelectedStockType == 'Physical'
                                        ? const Color(0xFF3B82F6)
                                        : Colors.white,
                                    borderRadius: const BorderRadius.only(
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                      ...
                                      fontFamily: 'Inter',
                                      color:
                                          _localSelectedStockType == 'Physical'
                                          ? Colors.white
                                          : const Color(0xFF3B82F6),
                                    ),
                                  ),
              ...
              (widget.productId == null || widget.productId!.isEmpty)
                  ...
                  : ref
                        .watch(itemWarehouseStocksProvider(widget.productId!))
                        .when(
                          data: (stocks) {
                            final sorted = [...stocks];
                            sorted.sort((a, b) {
                          ...
                          error: (e, _) => Center(
                            child: Padding(
                              padding: const EdgeInsets.all(16),
                              child: Text(
                                'Error loading warehouse stocks: $e',
                                style: const TextStyle(
                                  fontSize: 12,
                                  color: Colors.grey,
                                ),
