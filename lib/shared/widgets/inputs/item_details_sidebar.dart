...
class ItemDetailsSidebar extends ConsumerStatefulWidget {
  /// Optional item name hint (display only; content is driven by the provider).
  final String? itemName;

  /// Initial tab to open (0 = Item Details, 1 = Stock Locations, 2 = Transactions).
  final int initialTabIndex;

  /// Called instead of `closeEndDrawer()` when the sidebar is shown as an
  /// overlay rather than an end-drawer (e.g. the assembly create page).
