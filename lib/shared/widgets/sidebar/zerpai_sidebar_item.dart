...
class _ZerpaiSidebarItemState extends State<ZerpaiSidebarItem> {
  ...
  static const Color _expandedActiveBg = Color(0xFF2A3A55);
  static const Color _blue = Color(0xFF1B8EF1);
  ...
  Widget build(BuildContext context) {
    ...
    final Color bgColor = widget.isActive
        ? (widget.isSubItem
              ? _blue
              : _expandedActiveBg) // ✅ always apply for parent
        : _hover
        ? _hoverBg
        : Colors.transparent;
          ...
          GestureDetector(
            ...
            child: Padding(
              ...
              child: Container(
                ...
                height: 26,
                decoration: BoxDecoration(
                  color: Colors.white.withValues(alpha: 46), // 0.18 * 255 ≈ 46
          ...
          SizedBox(
            ...
            child: Text(
              ...
              style: TextStyle(
                ...
                color: widget.isActive
                    ? Colors.white
                    : Colors.white.withValues(alpha: 95), // 0.75 * 255
              ),
            ),
          ),
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: Colors.white.withValues(
                      alpha: widget.isActive ? 115 : 71, // 0.45*255 , 0.28*255
                    ),
