...
class AdvancedCustomerSearchModal extends StatefulWidget {
  const AdvancedCustomerSearchModal({super.key});
    ...
    return showGeneralDialog<String>(
      ...
      pageBuilder: (context, anim1, anim2) {
        return Align(
          ...
          child: const AdvancedCustomerSearchModal(),
        );
      },
...
class _AdvancedCustomerSearchModalState
  ...
  final List<Map<String, String>> _customers = [
    ...
    },
    {
      ...
      'id': 'CUS-00020',
      'email': '',
      'company': 'SAHAKAR MEDICALS AND SURGICALS ALANALLUR LLP',
      'phone': '',
    },
    {
      'name': 'SAHAKAR MEDIC...',
      'id': 'CUS-00019',
      'email': '',
      'company': 'SAHAKAR MEDICALS AND SURGICALS HYPER STORE LLP',
      'phone': '',
    },
  ];
