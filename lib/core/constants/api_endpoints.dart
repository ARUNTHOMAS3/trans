...
class ApiEndpoints {
  ...
  static String salesReturnReceives(String salesReturnId) =>
      'sales-returns/$salesReturnId/receives';
  static String salesReturnReceive(String salesReturnId, String receiveId) =>
      'sales-returns/$salesReturnId/receives/$receiveId';
