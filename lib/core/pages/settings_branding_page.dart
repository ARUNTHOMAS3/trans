...
// TODO(auth): Remove once auth is enabled; use real orgId from authUserProvider.
const String _kBrandingDevOrgId = '00000000-0000-0000-0000-000000000002';
...
class _SettingsBrandingPageState extends ConsumerState<SettingsBrandingPage> {
  ...
  String get _effectiveOrgId {
    ...
    return (user?.orgId.isNotEmpty == true) ? user!.orgId : _kBrandingDevOrgId;
  }
  ...
  Future<void> _saveBranding() async {
    ...
    try {
      final String orgId = _orgId.isNotEmpty ? _orgId : _kBrandingDevOrgId;
  ...
  Widget _buildSidebar() {
    ...
    return Container(
      ...
      child: ListView(
        ...
        children: [
          for (final _BrandingNavSection section in _navSections) ...[
            Padding(
            ...
            for (final _BrandingNavBlock block in section.blocks)
