...
class SalesByItemCustomizationPage extends StatefulWidget {
  const SalesByItemCustomizationPage({super.key});

  @override
  State<SalesByItemCustomizationPage> createState() =>
      _SalesByItemCustomizationPageState();
}

class _SalesByItemCustomizationPageState
    extends State<SalesByItemCustomizationPage> {
    ...
    return Column(
      ...
      children: [
        ...
        ReportCustomizationSection(
          ...
          helperText:
              'Use advanced filters to filter the report based on the fields of Reports, Locations, Contacts.',
