        ...
        child: Padding(
          ...
          child: salesAsync.when(
            data: (sales) {
              ...
              return _DailySalesTable(sales: sales);
            },
...
class _DailySalesTable extends StatelessWidget {
  ...
  const _DailySalesTable({required this.sales});

  @override
  Widget build(BuildContext context) {
    // Group all by date (ignoring time)
    final Map<String, _DailyStats> dailyStats = {};

    for (var sale in sales) {
      final dateKey = ReportFormatterCache.date('yyyy-MM-dd').format(sale.saleDate);
              ...
              return TableRow(
                children: [
                  Padding(
                    ...
                    child: Text(
                      ReportFormatterCache.date('dd MMM yyyy').format(stats.date),
                  ...
                  Padding(
                    padding: const EdgeInsets.all(12.0),
                    child: Text(
                      'â‚¹${stats.totalAmount.toStringAsFixed(2)}',
                      textAlign: TextAlign.right,
            ...
            TableRow(
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.all(12.0),
                  child: Text(
                    'â‚¹${sales.fold<double>(0, (p, s) => p + s.total).toStringAsFixed(2)}',
                    textAlign: TextAlign.right,
                    style: const TextStyle(
                      fontWeight: FontWeight.bold,
                    ),
