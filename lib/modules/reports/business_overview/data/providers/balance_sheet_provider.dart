...
class BalanceSheetRequest {
  ...
  bool operator ==(Object other) {
    return other is BalanceSheetRequest &&
...
final balanceSheetProvider = FutureProvider.autoDispose
    .family<Map<String, dynamic>, BalanceSheetRequest>((ref, request) async {
  final repository = ref.watch(reportsRepositoryProvider);
  return repository.getBalanceSheet(
