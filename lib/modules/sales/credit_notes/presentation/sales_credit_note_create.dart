...
class SalesCreditNoteCreateScreen extends ConsumerStatefulWidget {
  ...
  /// Deep-link support: clone an existing credit note by ID.
  final String? cloneId;

  const SalesCreditNoteCreateScreen({
    super.key,
  ...
  @override
  ConsumerState<SalesCreditNoteCreateScreen> createState() =>
      _SalesCreditNoteCreateScreenState();
}
...
class _SalesCreditNoteCreateScreenState
  ...
  void initState() {
    super.initState();
    creditNoteNumberCtrl = TextEditingController(
      text: 'CN-${DateFormat('yyyyMMdd-HHmm').format(DateTime.now())}',
    );
  ...
  void _saveCreditNote() async {
    ...
    final order = SalesOrder(
      ...
      saleNumber: creditNoteNumberCtrl.text,
      reference: referenceCtrl.text,
      saleDate: creditNoteDate,
      status: 'confirmed',
