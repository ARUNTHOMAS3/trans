...
import '../notifiers/sales_order_controller.dart';
...
import '../../customers/models/sales_customer_model.dart';
...
import 'package:zerpai_erp/modules/sales/shared/widgets/sales_order_item_row.dart';
import 'package:zerpai_erp/modules/sales/shared/widgets/bulk_items_dialog.dart';
import 'package:zerpai_erp/shared/widgets/skeleton.dart';
import 'package:zerpai_erp/modules/sales/shared/widgets/advanced_customer_search_dialog.dart';
...
import 'package:zerpai_erp/modules/sales/shared/widgets/sales_order_preferences_dialog.dart';
...
class _SalesOrderCreateScreenState
  ...
  Future<void> _openSelectedCustomerDetailsSidebar() async {
    ...
    try {
      final api = ref.read(salesOrderControllerProvider.notifier);
  ...
  Widget _footerBanner() {
    ...
    final double horizontalPadding = screenWidth < 1000 ? 16.0 : 40.0;

    return Stack(
      clipBehavior: Clip.none,
      children: [
        // Invisible copy to define the vertical space in the Column
        Opacity(
          opacity: 0,
          child: Container(
        ...
        // Positioned layer that bleeds into the margins
        Positioned(
