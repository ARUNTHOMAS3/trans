part of '../pages/sales_customer_create.dart';
    ...
    return Column(
      ...
      children: [
        ...
        _buildFormRow(
          label: 'Display Name',
          required: true,
          hasError: _hasFieldError('displayName'),
          showInfo: true,
          tooltip:
          ...
          child: FormDropdown<String>(
            ...
            errorText: _fieldError('displayName'),
            onChanged: (v) => _runLiveValidation(() {
              displayNameCtrl.text = v ?? '';
              _validateDisplayNameField(v);
            }),
          ),
        ),
              ...
              builder: (context, ref, child) {
                ...
                final items =
                    customersAsync.value
                        ?.where(
                          (c) => c.customerType?.toLowerCase() == 'individual',
                        )
                        .map((c) => c.displayName)
                        .toList() ??
                    [];
        ...
        // 4.5 Business Type
        if (customerType == 'Business' && !_isBranchScopedRole) ...[
          _buildFormRow(
            label: 'Business Type',
            showInfo: true,
            tooltip:
        ...
        _buildFormRow(
          ...
          child: CustomTextField(
            ...
            prefixBox: true,
            onChanged: (value) =>
                _runLiveValidation(() => _validateEmailField(value)),
          ),
        ),
        ...
        Column(
          ...
          children: [
            _buildFormRow(
              ...
              required: true,
              hasError: _hasFieldError('customerNumber'),
              child: Row(
                children: [
                  Expanded(
                    child: CustomTextField(
            ...
            if (_hasFieldError('customerNumber'))
              Padding(
                padding: const EdgeInsets.only(left: 252, top: 4, bottom: 12),
                child: Text(
                  _fieldError('customerNumber') ?? '',
        ...
        _buildFormRow(
          label: 'Phone',
          hasError: _hasFieldError('phone') || _hasFieldError('mobilePhone'),
          showInfo: true,
            ...
            children: [
              Expanded(
                child: PhoneInputField(
                  ...
                  onPrefixChanged: (v) => _state(() => phoneCode = v ?? '+91'),
                  onChanged: (value) => _runLiveValidation(
              ...
              Expanded(
                child: PhoneInputField(
                  ...
                  selectedPrefix: mobileCode,
                  errorText: _fieldError('mobilePhone'),
                  onPrefixChanged: (v) => _state(() => mobileCode = v ?? '+91'),
                  onChanged: (value) => _runLiveValidation(
