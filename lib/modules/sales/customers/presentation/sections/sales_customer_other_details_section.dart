    ...
    return Padding(
      ...
      child: Column(
        children: [
            ...
            child: FormDropdown<String>(
              ...
              displayStringForValue: (id) =>
                  _paymentTermsList.firstWhere(
                    (it) => it['id'] == id,
                    orElse: () => <String, dynamic>{'term_name': id},
                  )['term_name'] ??
                  id,
              showSettings: true,
          ...
          _buildFormRow(
            label: 'Price List',
            hasError: _hasFieldError('priceListId'),
            showInfo: true,
            tooltip:
            ...
            child: FormDropdown<String>(
              ...
              errorText: _fieldError('priceListId'),
              displayStringForValue: (id) {
  ...
  Widget _buildAdditionalDetails() {
    return Column(
      children: [
        ...
        _buildFormRow(
          label: 'WhatsApp',
          hasError: _hasFieldError('whatsappNumber'),
          child: CustomTextField(
            height: _inputHeight,
            controller: whatsappCtrl,
            errorText: _fieldError('whatsappNumber'),
            prefixBox: true,
            prefixWidget: SvgPicture.string(
            ...
            onChanged: (value) => _runLiveValidation(
              () => _validatePhoneField('whatsappNumber', value),
            ),
          ),
        ),
        _buildFormRow(
