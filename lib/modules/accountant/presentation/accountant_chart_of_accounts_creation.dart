...
class _ChartOfAccountsCreationPageState
  ...
  Widget _buildBody(BuildContext context) {
    ...
    if (!_didInitFromExtra) {
      ...
      if (!_didInitFromExtra && routeAccountId != null && routeAccountId.isNotEmpty) {
        final routeAccount = _findAccountById(accountsState.roots, routeAccountId);
      ...
      if (!_didInitFromExtra && (routeAccountId == null || routeAccountId.isEmpty)) {
        _didInitFromExtra = true;
      }
    }
