...
class SettingsUserRecord {
  SettingsUserRecord({
    ...
    this.availableLocations = const <SettingsLocationRecord>[],
  ...
  final List<SettingsLocationRecord> availableLocations;
  ...
  String get roleLabel {
    ...
    switch (role.trim().toLowerCase()) {
      ...
      case 'branch_admin':
        return 'Branch Admin';
      default:
        return role.trim().isEmpty ? 'Unassigned' : role;
    }
  }
  ...
  factory SettingsUserRecord.fromJson(Map<String, dynamic> json) {
    ...
    return SettingsUserRecord(
      ...
      defaultBusinessBranchId: json['default_business_branch_id']?.toString(),
      defaultWarehouseBranchId: json['default_warehouse_branch_id']?.toString(),
...
class _SettingsUsersRolesShellState
  ...
  Widget _buildSidebar(BuildContext context) {
    return SettingsNavigationSidebar(currentPath: widget.activeRoute);
  }
