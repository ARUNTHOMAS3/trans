...
class _InvoiceStatusRecord {
  const _InvoiceStatusRecord({
  ...
  _InvoiceStatusRecord copyWith({
    String? customStatusFor,
    String? statusName,
    String? description,
    Color? labelColor,
  }) {
    return _InvoiceStatusRecord(
...
class _StatusDialogResult {
  ...
  final _InvoiceStatusRecord? record;
  final bool deleted;
}
...
class InvoicesSettingsPage extends ConsumerStatefulWidget {
  const InvoicesSettingsPage({
    super.key,
    this.initialTab = InvoicesSettingsTab.preferences,
  });

  final InvoicesSettingsTab initialTab;

  @override
  ConsumerState<InvoicesSettingsPage> createState() =>
      _InvoicesSettingsPageState();
}
...
class _InvoicesSettingsPageState extends ConsumerState<InvoicesSettingsPage> {
  ...
  bool _allowEditingSentInvoice = true;
  bool _associateExpenseReceipts = true;
  _InvoiceOrderNumberOption _invoiceOrderNumberOption =
      _InvoiceOrderNumberOption.useSalesOrderNumber;
  bool _getNotifiedPayOnline = true;
  bool _includePaymentReceipt = true;
  bool _automateThankYouNote = true;
  bool _qrCodeEnabled = false;
  _QrCodeTypeItem _qrCodeType = _qrCodeTypeItems[1];
  bool _hideZeroValueLineItems = true;
  late InvoicesSettingsTab _activeTab;
  ...
  List<SettingsSearchItem> _buildSearchItems() {
    return <SettingsSearchItem>[
      SettingsSearchItem(
        ...
        label: 'Preferences',
        subtitle: 'Invoices',
        keywords: const <String>['invoices', 'preferences'],
        onSelected: () => _openTab(InvoicesSettingsTab.preferences),
      ),
      SettingsSearchItem(
        group: 'Invoices',
        label: 'Invoice Cycle',
        ...
        onSelected: () => _openTab(InvoicesSettingsTab.invoiceCycle),
      ),
      SettingsSearchItem(
        group: 'Invoices',
        label: 'Statuses',
        ...
        onSelected: () => _openTab(InvoicesSettingsTab.statuses),
      ),
      SettingsSearchItem(
        group: 'Invoices',
  ...
  void _openTab(InvoicesSettingsTab tab) {
    final route = switch (tab) {
      InvoicesSettingsTab.invoiceCycle => AppRoutes.settingsInvoicesCycle,
      InvoicesSettingsTab.statuses => AppRoutes.settingsInvoicesStatuses,
      _ => AppRoutes.settingsInvoices,
    };
    if (_activeTab != tab) {
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          _InvoicesPageTitle(
                            trailing: _activeTab == InvoicesSettingsTab.statuses
                            ...
                            child: Scrollbar(
                              ...
                              child: SingleChildScrollView(
                                ...
                                padding: EdgeInsets.fromLTRB(
                                  _activeTab == InvoicesSettingsTab.statuses
                                      ? 0
                                      : 22,
                                  _activeTab == InvoicesSettingsTab.statuses
                                      ? 0
                                ...
                                child: Align(
                                  ...
                                  child:
                                      _activeTab == InvoicesSettingsTab.statuses
                                      ? const _InvoicesStatusesContent()
                                      : ConstrainedBox(
                                          ...
                                          child:
                                              ...
                                              : _InvoicesPreferencesContent(
                                                  ...
                                                  onAssociateExpenseReceiptsChanged:
                                                      (value) {
                                                        setState(
                                                          () =>
                                                              _associateExpenseReceipts =
                                                  ...
                                                  onInvoiceOrderNumberOptionChanged:
                                                      (value) {
                                                        if (value != null) {
                                                          setState(
                                                            () =>
                                                  ...
                                                  onIncludePaymentReceiptChanged:
                                                      (value) {
                                                        setState(
                                                          () =>
                                                              _includePaymentReceipt =
                                                  ...
                                                  onHideZeroValueLineItemsChanged:
                                                      (value) {
                                                        setState(
                                                          () =>
                                                              _hideZeroValueLineItems =
...
enum _InvoiceOrderNumberOption {
  useSalesOrderNumber,
  useSalesOrderReferenceNumber,
}

class _InvoicesPreferencesContent extends StatelessWidget {
  const _InvoicesPreferencesContent({
    required this.allowEditingSentInvoice,
    required this.associateExpenseReceipts,
    required this.invoiceOrderNumberOption,
    required this.getNotifiedPayOnline,
    required this.includePaymentReceipt,
    required this.automateThankYouNote,
    required this.qrCodeEnabled,
    required this.qrCodeType,
    required this.qrCodeDescController,
    required this.hideZeroValueLineItems,
    required this.termsController,
    required this.customerNotesController,
    required this.onAllowEditingSentInvoiceChanged,
    required this.onAssociateExpenseReceiptsChanged,
    required this.onInvoiceOrderNumberOptionChanged,
    required this.onGetNotifiedPayOnlineChanged,
    required this.onIncludePaymentReceiptChanged,
    required this.onAutomateThankYouNoteChanged,
  ...
  final bool associateExpenseReceipts;
  final _InvoiceOrderNumberOption invoiceOrderNumberOption;
  final bool getNotifiedPayOnline;
  final bool includePaymentReceipt;
  final bool automateThankYouNote;
  final bool qrCodeEnabled;
  final _QrCodeTypeItem qrCodeType;
  final TextEditingController qrCodeDescController;
  final bool hideZeroValueLineItems;
  final TextEditingController termsController;
  final TextEditingController customerNotesController;

  final ValueChanged<bool> onAllowEditingSentInvoiceChanged;
  final ValueChanged<bool> onAssociateExpenseReceiptsChanged;
  final ValueChanged<_InvoiceOrderNumberOption?>
  onInvoiceOrderNumberOptionChanged;
  final ValueChanged<bool> onGetNotifiedPayOnlineChanged;
  final ValueChanged<bool> onIncludePaymentReceiptChanged;
  final ValueChanged<bool> onAutomateThankYouNoteChanged;
    ...
    return Column(
      ...
      children: [
        _SettingsCheckboxRow(
          value: allowEditingSentInvoice,
          label: 'Allow editing of Sent Invoice?',
          onChanged: onAllowEditingSentInvoiceChanged,
        ),
        _SettingsCheckboxRow(
          value: associateExpenseReceipts,
          label: 'Associate and display expense receipts in Invoice PDF',
          onChanged: onAssociateExpenseReceiptsChanged,
        ),
        ...
        _SettingsRadioRow<_InvoiceOrderNumberOption>(
          value: _InvoiceOrderNumberOption.useSalesOrderNumber,
          groupValue: invoiceOrderNumberOption,
          label: 'Use Sales Order Number',
          onChanged: onInvoiceOrderNumberOptionChanged,
        ),
        _SettingsRadioRow<_InvoiceOrderNumberOption>(
          value: _InvoiceOrderNumberOption.useSalesOrderReferenceNumber,
          groupValue: invoiceOrderNumberOption,
        ...
        const SizedBox(height: 8),
        _SettingsCheckboxRow(
          value: getNotifiedPayOnline,
          label: 'Get notified when customers pay online',
          onChanged: onGetNotifiedPayOnlineChanged,
        ),
        _SettingsCheckboxRow(
          value: includePaymentReceipt,
          label:
              'Do you want to include the payment receipt along with the Thank You note?',
          onChanged: onIncludePaymentReceiptChanged,
        ),
        _SettingsCheckboxRow(
          value: automateThankYouNote,
          label:
              'Automate thank you note to customer on receipt of online payment',
          onChanged: onAutomateThankYouNoteChanged,
        ),
        const SizedBox(height: 22),
        const Divider(height: 1, thickness: 1, color: AppTheme.borderLight),
        const SizedBox(height: 22),
          ...
          RichText(
            text: TextSpan(
              ...
              children: [
                ...
                const TextSpan(
                  text:
                      'You can display this QR code in your invoice PDFs. To do this, edit the invoice template from ',
                ),
                TextSpan(
                ...
                const TextSpan(
                  text:
                      ' and select the Show Invoice QR Code checkbox in the Other Details section.',
                ),
              ],
            ),
          ),
        ...
        const SizedBox(height: 8),
        _SettingsCheckboxRow(
          value: hideZeroValueLineItems,
          label: 'Hide zero-value line items',
          onChanged: onHideZeroValueLineItemsChanged,
        ),
        const SizedBox(height: 6),
        Text(
        ...
        SizedBox(
          ...
          child: TextField(
            ...
            maxLines: 7,
            style: AppTheme.bodyText.copyWith(fontSize: 14),
            decoration: _textAreaDecoration('Thanks for your business.'),
          ),
        ),
...
class _InvoicesCycleContent extends StatelessWidget {
  const _InvoicesCycleContent();
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text(
          'Configure invoice cycle preference for manual invoices',
          style: AppTheme.bodyText.copyWith(
            fontSize: 15,
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      'Create invoice cycle rules for marketplace orders',
                      style: AppTheme.pageTitle.copyWith(
                        fontSize: 16,
                        fontWeight: FontWeight.w500,
                        color: const Color(0xFF20263A),
                    ...
                    const SizedBox(height: 10),
                    Text(
                      'Create invoice cycle rules for different marketplaces to create transactions like invoices, packages, and shipments automatically after an order is received from a marketplace.',
                      style: AppTheme.bodyText.copyWith(
                        fontSize: 14,
                        height: 1.5,
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              ...const [
                'You have to execute the invoice cycle from the invoice details page for orders that have been imported manually.',
                'The custom fields in transactions will be left empty, even if the custom fields are mandatory.',
                'If a invoice contains items with either serial number tracking or batch tracking, you cannot create packages or invoices while automating the invoice cycle.',
                'You have to disable any functions that might interfere with the invoice cycle. Contact support for more details.',
...
class _InvoicesStatusesContent extends StatefulWidget {
  const _InvoicesStatusesContent();

  @override
  State<_InvoicesStatusesContent> createState() =>
      _InvoicesStatusesContentState();
}

class _InvoicesStatusesContentState extends State<_InvoicesStatusesContent> {
  ...
  Future<void> _handleEditStatus(
    ...
    int index,
    _InvoiceStatusRecord record,
  ) async {
    final result = await _showEditStatusDialog(context, record);
    if (result == null) return;

    final next = List<_InvoiceStatusRecord>.from(
      _invoiceStatusesNotifier.value,
    );
    if (result.deleted) {
      next.removeAt(index);
      _invoiceStatusesNotifier.value = next;
      if (context.mounted) {
  ...
  @override
  Widget build(BuildContext context) {
    return ValueListenableBuilder<List<_InvoiceStatusRecord>>(
      valueListenable: _invoiceStatusesNotifier,
                ...
                Flexible(
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Select the transactions that has to be created after a invoice.',
                          style: AppTheme.bodyText.copyWith(
                            fontSize: 12.5,
...
class _NewStatusDialog extends StatefulWidget {
  ...
  final String title;
  final _InvoiceStatusRecord? initialRecord;
...
class _InvoicesSettingsHeader extends StatelessWidget {
  const _InvoicesSettingsHeader({
...
class _InvoicesPageTitle extends StatelessWidget {
  const _InvoicesPageTitle({this.trailing});
...
class _StatusesHeaderButton extends StatelessWidget {
  ...
  Future<void> _handleNewStatus(BuildContext context) async {
    ...
    _invoiceStatusesNotifier.value = <_InvoiceStatusRecord>[
      ..._invoiceStatusesNotifier.value,
      result.record!,
    ];
    if (context.mounted) {
...
class _InvoicesTabsRow extends StatelessWidget {
  const _InvoicesTabsRow({
    required this.activeTab,
    required this.onTabSelected,
  });

  final InvoicesSettingsTab activeTab;
  final ValueChanged<InvoicesSettingsTab> onTabSelected;

  static const List<(String, InvoicesSettingsTab)> _tabs =
      <(String, InvoicesSettingsTab)>[
        ('Preferences', InvoicesSettingsTab.preferences),
        ('Approvals', InvoicesSettingsTab.approvals),
        ('Fields', InvoicesSettingsTab.fields),
        ('Validation Rules', InvoicesSettingsTab.validationRules),
        ('Record Locking', InvoicesSettingsTab.recordLocking),
        ('Buttons', InvoicesSettingsTab.buttons),
        ('Related Lists', InvoicesSettingsTab.relatedLists),
      ];
...
class _SettingsRadioRow<T> extends StatelessWidget {
