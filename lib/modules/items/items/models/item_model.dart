...
class Item {
  ...
  factory Item.fromJson(Map<String, dynamic> json) {
    return Item(
      ...
      productTypeName:
          json['productType']?['name'] ?? json['product_type_name'],
      ...
      inventoryAccountName:
          json['inventoryAccount']?['user_account_name'] ??
          json['inventoryAccount']?['account_name'] ??
          json['inventory_account_name'] ??
          json['inventory_account']?['user_account_name'] ??
          json['inventory_account']?['account_name'],
      salesAccountName:
          json['salesAccount']?['user_account_name'] ??
          json['salesAccount']?['account_name'] ??
          json['sales_account_name'] ??
          json['sales_account']?['user_account_name'] ??
          json['sales_account']?['account_name'],
      purchaseAccountName:
          json['purchaseAccount']?['user_account_name'] ??
          json['purchaseAccount']?['account_name'] ??
          json['purchase_account_name'] ??
          json['purchase_account']?['user_account_name'] ??
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      // Backend computes these operational totals; keep read-only in client model.
      // Sending them in create/update payloads triggers whitelist validation errors.
  ...
  static Item dummy() {
    return Item(
      ...
      manufacturerName: 'Sample Pharma',
    );
  }

  static List<Item> dummyList(int count) =>
      List.generate(count, (_) => dummy());
}
