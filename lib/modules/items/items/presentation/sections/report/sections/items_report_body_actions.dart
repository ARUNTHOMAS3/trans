...
extension _ItemsReportBodyActions on _ItemsReportBodyState {
  String _resolveOrgSystemId(BuildContext context) {
    final routeOrgId =
        GoRouterState.of(context).pathParameters['orgSystemId']?.trim() ?? '';
    if (routeOrgId.isNotEmpty) return routeOrgId;
    final user = ref.read(authUserProvider);
    final userOrgId = (user?.orgSystemId ?? '').trim();
    return userOrgId;
  }
                        ...
                        child: ElevatedButton.icon(
                          ...
                          onPressed: () {
                            context.goNamed(
                              ...
                              pathParameters: {
                                'orgSystemId': _resolveOrgSystemId(context),
                              },
                            );
                          },
                        ),
