                    ...
                    _zerpaiField(
                      ...
                      child: _zerpaiDropdown<String>(
                        ...
                        onSettingsTap: () => _openSyncManageDialog(
                          ...
                          onCreateOne: controller.createStorageLocation,
                ...
                child: Column(
                  children: [
                    ...
                    _zerpaiField(
                      label: "Reorder Rule",
                      tooltip:
                          "Branch-specific reorder rule. Suggested order quantity is calculated as Reorder Point + Additional Units from the selected rule.",
                      child: _zerpaiDropdown<String>(
            ...
            children: [
              Expanded(
                child: _zerpaiField(
                  label: "Reorder Point",
                  tooltip:
                      "For the current branch, trigger reorder planning when available stock reaches or falls below this quantity.",
