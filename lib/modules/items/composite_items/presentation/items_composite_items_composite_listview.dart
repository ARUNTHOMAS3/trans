      ...
      child: compositeItems.when(
        ...
        error: (_, __) => Column(
          ...
          children: [
            ...
            _buildTableHeader(false, const <CompositeItem>[]),
            const Expanded(
              child: Center(
                child: Text(
        ...
        Expanded(
          child: ListView.separated(
            ...
            separatorBuilder: (_, __) =>
                const Divider(height: 1, color: AppTheme.borderColor),
            itemBuilder: (_, __) => const _CompositeRowSkeleton(),
          ),
        ),
        _buildTableFooter(0),
      ],
...
class _CompositeRowSkeleton extends StatelessWidget {
  const _CompositeRowSkeleton();

  Widget _bar({double width = double.infinity}) {
    return Align(
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(flex: 3, child: _bar(width: 180)),
          const SizedBox(width: 14),
          Expanded(flex: 2, child: _bar(width: 110)),
          const SizedBox(width: 14),
          Expanded(flex: 2, child: _bar(width: 90)),
          const SizedBox(width: 14),
          Expanded(flex: 2, child: _bar(width: 80)),
          const SizedBox(width: 14),
          Expanded(flex: 2, child: _bar(width: 120)),
          const SizedBox(width: 14),
          Expanded(flex: 1, child: _bar(width: 52)),
        ],
      ),
    );
  }
