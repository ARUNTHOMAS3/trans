  ...
  void _openImagePreview({required int startIndex}) {
    ...
    showGeneralDialog(
      ...
      pageBuilder: (ctx, _, __) {
        return StatefulBuilder(
          builder: (ctx, setDlg) {
            const double scrollDeltaThreshold = 8;
            void goPrev() => setDlg(
              () => current =
            ...
            void handlePointerSignal(PointerSignalEvent event) {
              ...
              if (horizontal < scrollDeltaThreshold &&
                  vertical < scrollDeltaThreshold) {
                return;
              }
              final shouldGoNext = horizontal >= vertical
                  ? delta.dx > 0
                  : delta.dy > 0;
              if (shouldGoNext) {
                goNext();
