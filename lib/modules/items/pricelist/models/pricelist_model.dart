...
class PriceList extends Equatable {
  ...
  /// Creates a list of dummy PriceLists
  static List<PriceList> dummyList([int count = 5]) =>
      List.generate(count, (_) => PriceList.dummy());
...
class PriceListItemRate extends Equatable {
  ...
  final List<PriceListVolumeRange>? volumeRanges;
  ...
  /// Creates a dummy PriceListItemRate for loading states
  factory PriceListItemRate.dummy() => const PriceListItemRate(
  ...
  /// Creates a list of dummy PriceListItemRates
  static List<PriceListItemRate> dummyList([int count = 5]) =>
      List.generate(count, (_) => PriceListItemRate.dummy());
