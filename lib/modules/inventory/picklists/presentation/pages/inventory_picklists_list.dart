...
class _InventoryPicklistsListScreenState
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(picklistsProvider.notifier).refresh();
    });
  }
  ...
  Future<void> _loadColumnSettings() async {
    try {
      ...
      final jsonStr = prefs.getString('picklist_table_columns_config');
      if (jsonStr != null) {
  ...
  Future<void> _saveColumnSettings() async {
    try {
      ...
      await prefs.setString('picklist_table_columns_config', jsonStr);
    } catch (e) {
...
// Removed local menu classes as they are now replaced by ZTableHeaderMenu reusable.
