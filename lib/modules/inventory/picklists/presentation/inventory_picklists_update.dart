...
class _InventoryPicklistsUpdateScreenState
  ...
  bool get _allBatchesAdded =>
      _filteredSelectedItems.isNotEmpty &&
      _filteredSelectedItems.every(
        (item) {
