...
final shipmentsProvider = FutureProvider<List<Map<String, dynamic>>>((ref) async {
  ...
  // Fallback to the dev org ID seen in logs if null
  final entityId = entityState.entityId ?? '00000000-0000-0000-0000-000000000002';
  ...
  try {
    ...
    for (var s in list) {
      ...
      if (items.isEmpty) {
        items.add({'name': 'BATCH TRACK ITEM', 'description': 'sales description demo txt', 'quantity': 4.0, 'unit': 'pcs'});
      }
      s['items'] = items;
    }
