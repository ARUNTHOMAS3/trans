...
final filteredPriceListsProvider = Provider<AsyncValue<List<PriceList>>>((ref) {
  final priceListsAsync = ref.watch(priceListNotifierProvider);
...
class SortState {
  ...
  const SortState({required this.column, this.ascending = true});

  SortState copyWith({String? column, bool? ascending}) {
    return SortState(
