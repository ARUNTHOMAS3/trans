...
class BranchPriceListEditScreen extends ConsumerStatefulWidget {
  ...
  const BranchPriceListEditScreen({
    super.key,
...
class _BranchPriceListEditScreenState
    extends ConsumerState<BranchPriceListEditScreen> {
                ...
                child: Row(
                  ...
                  children: [
                    Checkbox(
                      ...
                      onChanged: (val) =>
                          setState(() => _isDiscountEnabled = val ?? false),
                      activeColor: AppTheme.primaryBlue,
                    ),
                    const Flexible(
                      child: Text(
  ...
  void _addVolumeRange(
    ...
    setState(() {
      ...
      updated.add(
        BranchPriceListVolumeRange(startQuantity: start, customRate: 0),
      );
        ...
        child: Padding(
          ...
          child: Text.rich(
            TextSpan(
              ...
              style: TextStyle(
                fontSize: 13,
                color: required ? AppTheme.errorRed : AppTheme.textSubtle,
                fontWeight: FontWeight.w500,
              ),
              children: [
                if (required)
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      final updated = _currentBranchPriceList!.copyWith(
        ...
        pricingScheme: _currentBranchPriceList!.pricingScheme,
        priceListType: _currentBranchPriceList!.priceListType,
        details: detailsText,
        roundOffPreference: _roundOffTo,
        status: _status,
        transactionType: _currentBranchPriceList!.transactionType,
        ...
        itemRates: _currentBranchPriceList!.priceListType == 'individual_items'
