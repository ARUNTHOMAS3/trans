...
class User {
  ...
  final String? defaultBusinessBranchEntityId;
  ...
  User({
    ...
    this.defaultBusinessBranchEntityId,
  ...
  User copyWith({
    ...
    String? defaultBusinessBranchEntityId,
    ...
    return User(
      ...
      defaultBusinessBranchEntityId:
          defaultBusinessBranchEntityId ?? this.defaultBusinessBranchEntityId,
      defaultWarehouseBranchId:
  ...
  Map<String, dynamic> toJson() => {
    ...
    'defaultBusinessBranchEntityId': defaultBusinessBranchEntityId,
