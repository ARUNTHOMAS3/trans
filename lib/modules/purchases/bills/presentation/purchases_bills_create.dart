        ...
        children: [
              ...
              children: [
                ...
                PopupMenuButton<String>(
                  ...
                  itemBuilder: (_) => const [
                    PopupMenuItem(
                      value: 'bulk_update',
                      child: Text('Bulk Update Line Items'),
                    ),
                  ],
                  child: const Row(
                    children: [
          ...
          if (_bulkMode)
            Container(
              ...
              child: Row(
                children: [
                  _buildBulkActionButton('Update Reporting Tags'),
                  const SizedBox(width: 8),
                  _buildBulkActionButton('Update Account'),
                  const SizedBox(width: 8),
                  _buildBulkActionButton('Update Discount'),
                  const Spacer(),
                  IconButton(
                    onPressed: () => setState(() {
                      _bulkMode = false;
