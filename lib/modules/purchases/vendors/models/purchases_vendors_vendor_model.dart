class Vendor {
  ...
  final List<Map<String, dynamic>>? vendorAddresses;
  ...
  Vendor copyWith({
    ...
    return Vendor(
      ...
      vendorLanguage: vendorLanguage ?? this.vendorLanguage,
      ...
      tdsRateId: tdsRateId ?? this.tdsRateId,
      ...
      vendorAddresses: vendorAddresses ?? this.vendorAddresses,
  ...
  factory Vendor.fromJson(Map<String, dynamic> json) {
    return Vendor(
      ...
      vendorAddresses: (json['vendor_addresses'] as List?)
  ...
  Map<String, dynamic> toJson() {
    ...
    if (vendorAddresses != null && vendorAddresses!.isNotEmpty) {
      data['vendorAddresses'] = vendorAddresses;
    }
  ...
  static Vendor dummy() {
    return Vendor(
      id: 'dummy-id',
      displayName: 'Loading Vendor Name',
