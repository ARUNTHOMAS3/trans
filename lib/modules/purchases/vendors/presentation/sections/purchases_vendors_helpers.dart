...
extension _PurchasesVendorsHelpers on _PurchasesVendorsVendorCreateScreenState {
  ...
  void _trimPhoneForCode(String code, TextEditingController controller) {
    if (code.isEmpty) return;
    final maxLength = _phoneMaxLengthForCode(code);
    final text = controller.text;
    final digitsOnly = text.replaceAll(RegExp(r'[^0-9]'), '');
    final trimmed = digitsOnly.length > maxLength
