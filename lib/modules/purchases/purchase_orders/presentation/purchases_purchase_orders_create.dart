...
class _POCreateState extends ConsumerState<PurchaseOrderCreateScreen> {
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ZTooltip(
                      message: 'Line items to be purchased',
                      child: const Text(
                        'Item Table',
                        style: TextStyle(
                          fontSize: 14,
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              // X clear logic (Empty row instead of removing)
                                              ZTooltip(
                                                message: 'Clear Item Data',
                                                child: GestureDetector(
                                                  onTap: () {
                                                    ctrl.nameCtrl.clear();
                                                    ctrl.qtyCtrl.text = '1.00';
                                                    ctrl.rateCtrl.text = '0.00';
                                                    ctrl.discountCtrl.text =
                                                        '0.00';
                                                    ctrl.descCtrl.clear();
  ...
  Widget _buildTotalsPanel(PurchaseOrderState poState) {
    ...
    final itemCount = poState.items.where((i) => !i.isHeader).length;
          ...
          Row(
            ...
            children: [
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('Sub Total', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: _labelColor)),
                  if (itemCount > 0)
                    Text(
                      'Total Quantity: ${totalQty.toStringAsFixed(0)}',
                      style: const TextStyle(
                        fontSize: 11,
                        color: _hintColor,
                      ),
  ...
  Widget _footerBanner(PurchaseOrderState poState) {
    return Container(
      width: double.infinity,
      decoration: const BoxDecoration(
        color: Color(0xFFF9FAFB), // Soft Blue Banner background
        border: Border(
