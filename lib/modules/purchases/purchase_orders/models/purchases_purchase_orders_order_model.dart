...
class PurchaseOrderItem {
  ...
  factory PurchaseOrderItem.fromJson(Map<String, dynamic> json) {
    ...
    return PurchaseOrderItem(
      ...
      taxRate: (json['itemTaxRate'] as num?)?.toDouble() ?? (json['tax_rate'] as num?)?.toDouble() ?? 0.0,
      taxAmount: (json['taxAmount'] as num?)?.toDouble() ?? (json['tax_amount'] as num?)?.toDouble() ?? 0.0,
...
class PurchaseOrder {
  ...
  factory PurchaseOrder.fromJson(Map<String, dynamic> json) {
    ...
    return PurchaseOrder(
      ...
      tdsTcsId: json['tds_id'] as String? ?? json['tds_tcs_id'] as String?,
