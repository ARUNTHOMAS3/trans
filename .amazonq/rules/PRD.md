...
**📄 Detailed Reference:** See **[`prd_folder_structure.md`](../../PRD/prd_folder_structure.md)** for the complete folder structure guide, including:
...
- **Reusable widgets** (forms, layout): `lib/shared/widgets/`
