...
flowchart TD
    ...
    FORM --> F3[Branch / warehouse location]
    FORM --> F4[Date]
    FORM --> F5[Notes]
...
flowchart TD
    ...
    API --> STOCK_UPDATE[Update branch_inventory]
...
flowchart TD
    ...
    API --> DEDUCT[Deduct from source branch_inventory]
    DEDUCT --> ADD[Add to destination branch_inventory]
```
...
erDiagram
    ...
    branch_inventory }o--|| products : tracks
    branch_inventory }o--|| branchs : in
```
