...
import 'package:zerpai_erp/modules/sales/invoices/presentation/sales_invoice_list.dart';
...
import 'package:zerpai_erp/modules/pricelists/pricelist/presentation/pricelist_overview.dart';
import 'package:zerpai_erp/modules/pricelists/pricelist/presentation/pricelist_add.dart';
import 'package:zerpai_erp/modules/pricelists/pricelist/presentation/pricelist_edit.dart';
...
import 'package:zerpai_erp/modules/purchases/vendor_credits/presentation/purchases_vendor_credits_add.dart';
      ...
      routes: [
        ShellRoute(
          ...
          routes: [
            ...
            ...buildSettingsRoutes(
              fallbackRouteSystemId: _kFallbackRouteSystemId,
            ...
            GoRoute(
              ...
              builder: (context, state) {
                ...
                final vendorCreditId = state.uri.queryParameters['vendorCreditId'];
                return VendorCreditsAddPage(
                  billId: billId,
