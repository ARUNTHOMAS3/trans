...
- Multi-tenancy:
  - TenantMiddleware extracts org/branch context and guards endpoints.
- Controllers:
...
Tenant-->>Backend : "Attach org/branch context"
...
- TenantMiddleware:
  ...
  - Includes commented production code for JWT parsing and header validation (org/branch).
...
- Symptoms:
  - Requests fail with missing org/branch context or unauthorized errors.
- Steps:
