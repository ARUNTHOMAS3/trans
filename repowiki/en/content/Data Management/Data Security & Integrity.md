...
TM->>TM : "Attach tenantContext (orgId/branchId/role)"
...
- Purpose: Enforce tenant boundaries by attaching orgId/branchId/role to each request and skipping checks for health endpoints.
- Development vs Production: Placeholder tenant context is injected for development; production logic is present as commented code and includes extracting org/branch from headers and verifying JWT claims.
...
- Required Actions for Production:
  ...
  - Create policies enforcing orgId and branchId constraints.
...
Enable --> Policies["Create orgId/branchId policies"]
...
- RLS Overhead: Enabling RLS adds predicate evaluation; ensure appropriate indexes on orgId/branchId columns.
...
- Appendix A: RLS Enablement Checklist
  - Enable RLS on all tenant-scoped tables.
  - Create orgId/branchId policies.
