...
- Storage/rack: multi-outlet location identifiers.
...
- Multi-outlet tracking is supported via storage and rack identifiers.
...
- storageId and rackId: outlet/location association.
...
### Multi-Outlet Inventory Tracking
- Storage and rack identifiers enable multi-outlet tracking.
