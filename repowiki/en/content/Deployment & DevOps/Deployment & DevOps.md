...
- Middleware and tenant isolation:
  - Tenant middleware injects organization/outlet context; development bypass is present pending production auth implementation.
...
### Middleware and Tenant Isolation
- Tenant middleware attaches org/outlet context to requests.
...
DevBypass --> |No| ProdAuth["Parse JWT and headers"] --> Attach["Attach org/outlet context"] --> Done
```
