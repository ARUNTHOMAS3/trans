...
- Indexes: presence of indexes on org/outlet, type, category, vendor, selectable, item_code
...
- Database query optimization: leverage existing indexes (org/outlet, type, category, vendor, selectable, item_code)
