...
- Design: Extends Express Request with tenantContext; attaches userId, orgId, outletId, role
...
- Tenant context: Ensure X-Org-Id header is present for protected endpoints; otherwise, UnauthorizedException is thrown
