...
- Behavior:
  ...
  - Production code is present as comments and can be enabled to parse Authorization headers and extract X-Org-Id/X-Outlet-Id.
...
- TenantMiddleware currently injects a test tenant context. Enable JWT parsing and enforce X-Org-Id/X-Outlet-Id headers for production.
