...
extension _ItemDetailComponents on _ItemDetailScreenState {
  String _resolveOrgSystemId() {
    final routeOrgId = GoRouterState.of(context).pathParameters['orgSystemId'];
    if (routeOrgId != null && routeOrgId.isNotEmpty) {
      return routeOrgId;
    }
    final user = ref.read(authUserProvider);
    if (user?.routeSystemId.isNotEmpty == true) {
      return user!.routeSystemId;
    }
    if (user?.orgSystemId.isNotEmpty == true) {
      return user!.orgSystemId;
    }
    return '0000000000';
  }
                    ...
                    onTap: () {
                      if (item.id != null) {
                        ...
                        context.goNamed(
                          ...
                          pathParameters: {
                            'orgSystemId': _resolveOrgSystemId(),
                            'id': item.id!,
                          },
                          queryParameters: qp,
                        );
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () => context.pushNamed(
                  ...
                  pathParameters: {'orgSystemId': _resolveOrgSystemId()},
                ),
  ...
  Widget _buildDetailHeader(Item item) {
    ...
    final canCreateAssemblies =
        user != null &&
        PermissionService.hasModuleAction(user, 'assemblies', action: 'create');
