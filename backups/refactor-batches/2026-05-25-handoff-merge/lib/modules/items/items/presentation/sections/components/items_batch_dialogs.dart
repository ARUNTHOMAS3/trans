...
class _CreateBatchDialogState extends State<CreateBatchDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final baseWidth = ResponsiveDialog.constraintsFor(context).maxWidth;
    final compactWidth = viewportWidth < 1024 ? baseWidth : 570.0;
    ...
    return Dialog(
      ...
      child: ConstrainedBox(
        constraints: BoxConstraints(
          ...
          maxHeight: (MediaQuery.maybeOf(context)?.size.height ?? 900) * 0.9,
        ),
        child: Container(
      ...
      children: [
        ...
        Expanded(
          child: Align(
            ...
            child: FractionallySizedBox(widthFactor: 5 / 6, child: field),
          ),
        ),
      ],
    );
