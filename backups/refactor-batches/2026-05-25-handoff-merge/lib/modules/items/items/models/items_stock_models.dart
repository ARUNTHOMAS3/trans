...
class BatchData {
  ...
  factory BatchData.fromJson(Map<String, dynamic> json) => BatchData(
    ...
    unitPack: (json['unitPack'] ?? '').toString(),
...
class TransactionData {
  ...
  final String? journalAccountId;
  final String? journalAccountName;
  ...
  TransactionData({
    ...
    this.reference,
    this.journalAccountId,
    this.journalAccountName,
  });
  ...
  Map<String, dynamic> toJson() => {
    ...
    'journalAccountName': journalAccountName,
  };
}
