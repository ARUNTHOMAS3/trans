  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      final updated = _currentPriceList!.copyWith(
        ...
        pricingScheme: _currentPriceList!.pricingScheme,
        priceListType: _currentPriceList!.priceListType,
        details: detailsText,
        roundOffPreference: _roundOffTo,
        status: _status,
        transactionType: _currentPriceList!.transactionType,
        isDiscountEnabled: _isDiscountEnabled,
        itemRates: _currentPriceList!.priceListType == 'individual_items'
