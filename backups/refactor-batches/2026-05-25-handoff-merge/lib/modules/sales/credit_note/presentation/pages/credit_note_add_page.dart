...
import 'package:zerpai_erp/modules/sales/credit_note/presentation/sales_item_quick_edit_dialog.dart';
...
class CreditNoteAddPage extends ConsumerStatefulWidget {
  final String? initialCustomer;
  final String? creditNoteId;

  const CreditNoteAddPage({super.key, this.initialCustomer, this.creditNoteId});

  @override
  ConsumerState<CreditNoteAddPage> createState() => _CreditNoteAddPageState();
}

class _CreditNoteAddPageState extends ConsumerState<CreditNoteAddPage> {
  ...
  Future<void> _openBatchDialog(_CnLineItem lineItem) async {
    final result = await showDialog<PicklistBatchDialogResult>(
      ...
      builder: (_) => PicklistSelectBatchesDialog(
        ...
        warehouseName: lineItem.warehouseLocation ?? _warehouseLocation,
        warehouseId: '',
        totalQuantity:
            double.tryParse(lineItem.returnQtyController.text.trim()) ?? 1,
...
class _CnCurrencyBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      height: _CreditNoteAddPageState._fieldHeight,
      padding: const EdgeInsets.symmetric(horizontal: 10),
      decoration: BoxDecoration(
        color: AppTheme.backgroundColor,
        border: Border.all(color: AppTheme.borderLight),
              ...
              IntrinsicHeight(
                child: Row(
                  ...
                  children: [
                    ...
                    _CnGridCell(
                      width: _CreditNoteAddPageState._accountColumnWidth,
                      backgroundColor: AppTheme.tableHeaderBg,
                      alignment: Alignment.topLeft,
                      child: const CnGridHeader(label: 'ACCOUNT'),
                    ),
                    _CnGridCell(
                      width: _CreditNoteAddPageState._quantityColumnWidth,
                      backgroundColor: AppTheme.tableHeaderBg,
                      alignment: Alignment.topRight,
                      child: const CnGridHeader(label: 'QUANTITY'),
                    ),
                    _CnGridCell(
                      width: _CreditNoteAddPageState._rateColumnWidth,
                      backgroundColor: AppTheme.tableHeaderBg,
                      alignment: Alignment.topRight,
                      child: const Row(
                    ...
                    _CnGridCell(
                      width: _CreditNoteAddPageState._discountColumnWidth,
                      backgroundColor: AppTheme.tableHeaderBg,
                      alignment: Alignment.topRight,
                      child: const CnGridHeader(label: 'DISCOUNT'),
                    ),
                    _CnGridCell(
                      width: _CreditNoteAddPageState._taxColumnWidth,
                      backgroundColor: AppTheme.tableHeaderBg,
                      alignment: Alignment.topLeft,
                      child: const Row(
                        children: [
                    ...
                    _CnGridCell(
                      width: _CreditNoteAddPageState._amountColumnWidth,
                      backgroundColor: AppTheme.tableHeaderBg,
                      alignment: Alignment.topRight,
                      showDivider: false,
              ...
              children: [
                      ...
                      Expanded(
                        child: item.name.isEmpty
                            ? FormDropdown<String>(
                                ...
                                height:
                                    _CreditNoteAddPageState._tableFieldHeight,
                ...
                _CnGridCell(
                  ...
                  child: FormDropdown<String>(
                    ...
                    hint: 'Select Account',
                    height: _CreditNoteAddPageState._tableFieldHeight,
                    hideBorderDefault: true,
