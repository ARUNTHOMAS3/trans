...
enum FileUploadButtonVariant { icon, button }
...
class FileUploadButton extends StatefulWidget {
  ...
  final FileUploadButtonVariant variant;
  ...
  const FileUploadButton({
    ...
    this.variant = FileUploadButtonVariant.button,
  });
...
class _FileUploadButtonState extends State<FileUploadButton> {
  ...
  Widget build(BuildContext context) {
    ...
    final uploadControl = widget.variant == FileUploadButtonVariant.button
        ? Material(
            color: Colors.white,
