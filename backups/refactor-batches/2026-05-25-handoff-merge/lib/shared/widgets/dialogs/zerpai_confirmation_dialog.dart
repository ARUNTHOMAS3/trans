...
enum ZerpaiConfirmationVariant { warning, success, danger }
...
Future<bool> showZerpaiConfirmationDialog(
  ...
  final confirmBackground = switch (variant) {
    ...
    ZerpaiConfirmationVariant.success => AppTheme.successGreen,
  ...
  final accentBackground = switch (variant) {
    ...
    ZerpaiConfirmationVariant.success => AppTheme.successBg,
