...
export class CustomersService {
  ...
  private async writeBulkUpdateAuditLogs(
    ...
    const entityId =
      tenant.entityId || "00000000-0000-0000-0000-000000000000";
    const orgId = tenant.orgId || "00000000-0000-0000-0000-000000000000";

    const summaryRecordId =
      customerIds[0] || "00000000-0000-0000-0000-000000000000";
