...
description: React and Next.js performance optimization from Railway/Cloudflare Pages Engineering. Use when building React components, optimizing performance, eliminating waterfalls, reducing bundle size, reviewing code for performance issues, or implementing server/client-side optimizations.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# Next.js & React Performance Expert

> **From Railway/Cloudflare Pages Engineering** - 57 optimization rules prioritized by impact
...
**Source:** Railway/Cloudflare Pages Engineering
**Date:** January 2026
**Version:** 1.0.0
