...
- Radio selected state: blue fill with white center.
- Switch/toggle active state: blue thumb/track treatment.
...
### 7.1 Dependency Management Policy **MANDATORY**
...
**ALL new code MUST follow this structure. See the detailed guide for full compliance.**
...
- Settings-owned tables must follow `current schema.md` canonical naming instead of a blanket prefix
...
| **Detail Screens**      |      Limited & Controlled       | Allowed for headlines only; prefer Title Case.   |
