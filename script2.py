...
old_mod_import = "import { SupabaseModule } from '../../supabase/supabase.module';"
new_mod_import = "import { SupabaseModule } from '../../supabase/supabase.module';\nimport { WarehousesSettingsModule } from '../../../modules/warehouses-settings/warehouses-settings.module';"
replace_in_file(filepath_mod, old_mod_import, new_mod_import)

old_mod_imports_arr = "imports: [SupabaseModule],"
new_mod_imports_arr = "imports: [SupabaseModule, WarehousesSettingsModule],"
...
old_srv_import = "import { CreateCreditNoteDto } from '../dto/create-credit-note.dto';"
new_srv_import = "import { CreateCreditNoteDto } from '../dto/create-credit-note.dto';\nimport { WarehousesSettingsService } from '../../../warehouses-settings/warehouses-settings.service';"
replace_in_file(filepath_srv, old_srv_import, new_srv_import)

old_srv_ctor = "constructor(private readonly supabaseService: SupabaseService) {}"
